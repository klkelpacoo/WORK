...
`;
    ...
    >
        ...
        <div class="col-12 text-center size-s">
            ...
            <div class="row padding-0 text-left ellipsis2Lines padding-bottom-s txt-info" style="font-size:10px;">
                <i class="flx-icon icon-building margin-right-s"></i><b>${Centro_Lan ? Centro_Lan : "Sin Centro"}</b>
            </div>
